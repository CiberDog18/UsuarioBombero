...
import com.example.usuario.adapters.PopupAdapter;
import com.example.usuario.includes.MyToolbar;
import com.example.usuario.models.DriverLocation;
            ...
            for (Location location : locationResult.getLocations()) {
                if (getApplicationContext() != null) {
                   ...
                   /* if (mMarker != null) {
                    ...
                    //   mMarker = mMap.addMarker(new MarkerOptions().position(new LatLng(location.getLatitude(), location.getLongitude())).title("Tu posicion").icon(BitmapDescriptorFactory.fromResource(R.drawable.map_marker)));
        ...
        result.setResultCallback(new ResultCallback<LocationSettingsResult>() {
            ...
            public void onResult(@NonNull LocationSettingsResult locationSettingsResult) {
                ...
                if (status.getStatusCode() == LocationSettingsStatusCodes.SUCCESS) {
                    ...
                    Toast.makeText(MapClientActivity.this, "La configuracion del GPS tiene algun error o no esta disponible", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
*/
    ...
    private void getActiveDrivers() {
        mGeofireProvider.getActiveDrivers(mCurrentLatlong, 10).addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                Marker marker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Conductor disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.car_topview)));
                marker.setTag(key);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_info) {
            Intent intent = new Intent(MapClientActivity.this, InfoBomberosActivity.class);
            startActivity(intent);
        }
